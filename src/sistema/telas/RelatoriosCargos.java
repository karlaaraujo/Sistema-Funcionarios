...
public class RelatoriosCargos extends JPanel {
    ...
    private void criarComponentes() {
        ...
        // instanciando gráfico em formato pizza usando JFreeChart
    ...
    // realiza a conexao com o banco de dados para obter os valores que serão apresentados no gráfico
    private DefaultPieDataset criarDadosGrafico() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao criar o relatório"+ex.getMessage());
            Navegador.inicio();
        }
