...
public class RelatoriosSalarios extends JPanel {
    ...
    private void criarComponentes() {
        ...
        // instanciando grafico de barra da lib JFreeChart
    ...
    // realiza conexão com o banco de dados para obter os valores que serão apresentados no gráfico
